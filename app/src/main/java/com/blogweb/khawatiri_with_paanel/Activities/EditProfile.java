...
import static com.blogweb.khawatiri_with_paanel.Constans.UPDATE_USER_INFO;
...
public class EditProfile extends AppCompatActivity {
    ...
    private void init() {
        ...
        Picasso.get().load(Constans.URL + "storage/profiles/"+img_url).into(profile_img);
        fname.setText(name);
    ...
    private void updateUserInfo() {
        ...
        dialog.setMessage("جاري التحديث..");
        dialog.show();
        String first_name = fname.getText().toString().trim();
        // String last_name = lname.getText().toString().trim();

        StringRequest request = new StringRequest(Request.Method.POST, UPDATE_USER_INFO, response ->{
                    ...
                    if (object.getString("message").equals("Token expired")){
                        ...
                        new Handler().postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                editor.clear();
                                editor.apply();
                                startActivity(new Intent(EditProfile.this, AuthActivity.class));
                                finish();
                            }
                        },2500);
